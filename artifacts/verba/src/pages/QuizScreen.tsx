...
import { fetchQuizWords, type QuizWord } from "@/lib/quizQueries";
...
export default function QuizScreen() {
  ...
  }, [deckParam, difficultyParam, requestedWords, fetchKey]);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <AnimatePresence>
          {isAnswered && !showFeedback && (
            ...
            >
              {currentIndex + 1 >= quizWords.length ? "Finish" : "Next →"}
            </motion.button>
          )}
        </AnimatePresence>
      </div>
      ...
      <FeedbackCard
        show={showFeedback}
        word={toFeedbackWord(currentWord)}
        isCorrect={isCorrect}
        isLast={currentIndex + 1 >= quizWords.length}
